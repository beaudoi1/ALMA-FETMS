    ...
    new Ajax.Request('widget_data.php' , 
			 ...
			 method: 'get',
				 ...
				 for(var counter = 0; counter < catNames.length; counter++ )
				     {
					 document.forms['widgetForm'].widgetcat.options[counter] = new Option(catNames[counter].getElementsByTagName("name")[0].firstChild.nodeValue,catNames[counter].getElementsByTagName("name")[0].firstChild.nodeValue, false, false);
    ...
    new Ajax.Request('widget_data.php?category='+category , 
			 ...
			 method: 'get',
				 ...
				 for(var counter = 0; counter < widgets.length; counter++ )
				     {
					 document.forms['widgetForm'].widgetid.options[counter] = new Option(widgets[counter].getElementsByTagName("name")[0].firstChild.nodeValue, widgets[counter].getElementsByTagName("name")[0].firstChild.nodeValue, false, false);
				     }
			     }
		     });
