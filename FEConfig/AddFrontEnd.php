...
<form action='<?php echo($_SERVER["PHP_SELF"]) ?>' method='post' name="FEUpdate" id="FEUpdate" onsubmit="return FormValidate(1)">
	<div id="sidebar2" >
			...
			<table id = "table5">
			<tr class="alt"><th colspan = "2">Enter new Front End Record</th></tr>
			<tr>
			<th width="100px" align = "right">FrontEnd SN:</td><td align="left"><input type=text name='sn' id='sn'>
			</td>
			</tr>
			<tr >
			<th align = "right">CAN SN:</td><td><input type=text name='esn0' id='esn0'></input></td>
			</tr>
			<tr>
			<th align = "right">Docs:</td><td><textarea cols=40 rows=2 name="lnk1" id="lnk1"></textarea></td>
			</tr>
			<tr>
			<th align = "right">Description:</td><td><textarea cols=40 rows=2 name="Description" id="Description"></textarea></td>
			</tr>
			<tr>
			<th align = "right">Notes:</td><td><textarea rows=3 cols=40 name='notes' id='notes'></textarea></td>
			</tr>
			...
			<tr >
			<th align = "right"><label for='location'>Location:</label></td><td><select name='location' id='location'>
			<option></option>
