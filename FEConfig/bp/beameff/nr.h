...
double qrombd(double (*func)(double), double a, double b);
...
float selectnr(unsigned long k, unsigned long n, float arr[]);
...
double trapzdd(double (*func)(double), double a, double b, int n);
